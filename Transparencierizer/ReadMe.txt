Make sure you choose the opaque option and then click the make transparent button again, or else the window will stay unclickable and transparent!
...
It wouldn make windows pass mouse and keyboard input even if that option wasn't selected.
Fixed